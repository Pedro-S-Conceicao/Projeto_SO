...
float *alocaVariavel()
{
    ...
    if ((variavel = (float *)malloc(sizeof(float))) == NULL)
    {
...
void *thrdSomarMatriz(void *args)
{
    ...
    unsigned int *linha = (unsigned int *)malloc(sizeof(unsigned int));
    unsigned int *coluna = (unsigned int *)malloc(sizeof(unsigned int));
